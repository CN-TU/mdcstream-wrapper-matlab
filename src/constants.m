...
switch select
    ...
    case 'moving'
        CONST.MIN_DISPLACEMENT_RATE = 0.005;
        CONST.MAX_DISPLACEMENT_RATE = 0.01;
        
        CONST.MIN_VECTOR_CHANGE_RATE = 0.5;
        CONST.MAX_VECTOR_CHANGE_RATE = 10;
    ...
    case 'space'
        ...
        CONST.MIN_ALPHA_FACTOR = 5;
        CONST.MAX_ALPHA_FACTOR = 10;
